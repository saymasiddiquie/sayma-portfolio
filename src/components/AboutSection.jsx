...
export default function AboutSection() {
  ...
  return (
    <section id="about" className="py-24 relative z-20 container mx-auto px-6 max-w-5xl">
      {/* 1. Section Header */}
      ...
      {/* 2. Photo Showcase & Social Badges (Directly After Title) */}
      <div className="flex flex-col items-center justify-center mb-14">
        <div className="relative group w-full max-w-[380px] sm:max-w-[420px] flex justify-center">
          <div className="absolute -inset-4 bg-gradient-to-r from-amber-500 via-orange-500 to-amber-500 rounded-[40px] blur-2xl opacity-50 group-hover:opacity-85 transition duration-500" />
          <div className="relative w-72 h-72 sm:w-88 sm:h-88 md:w-[380px] md:h-[380px] max-w-full aspect-square rounded-[36px] overflow-hidden glass-panel p-3 border-2 border-amber-500/60 shadow-2xl shadow-amber-500/25">
            <img
              src={personal.githubAvatar}
              alt={personal.name}
              className="w-full h-full object-cover rounded-[28px] transition-transform duration-700 group-hover:scale-105 group-hover:brightness-105"
            />
          </div>
        </div>

        {/* Social Badges & Resume CTA directly beneath photo */}
        <div className="flex flex-wrap items-center justify-center gap-3.5 mt-8">
          ...
          <button
            ...
            className="flex items-center gap-2 px-6 py-3.5 rounded-2xl bg-gradient-to-r from-amber-500 to-orange-500 text-slate-950 font-extrabold hover:scale-105 transition-all shadow-xl shadow-amber-500/20 text-sm cursor-pointer"
          >
      ...
      {/* 3. About Me Story Content (Directly After Photo) */}
