...
export default function ResumeModal({ isOpen, onClose }) {
  ...
  return (
    <div className="resume-modal-overlay fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6 md:p-10 overflow-y-auto bg-slate-950/80 backdrop-blur-md animate-in fade-in duration-300">
      {/* Modal Container */}
      <div className="resume-modal-container relative w-full max-w-4xl max-h-[90vh] bg-[#0c101d] border-2 border-amber-500/40 rounded-3xl shadow-2xl shadow-amber-500/10 flex flex-col overflow-hidden text-slate-200">
        
        {/* Modal Top Bar (Actions - Hidden in Print) */}
        <div className="resume-modal-topbar no-print flex items-center justify-between px-6 py-4 bg-slate-900/90 border-b border-slate-800 shrink-0">
          ...
          <div className="flex items-center gap-2">
            <button
              onClick={handlePrint}
              className="flex items-center gap-1.5 px-3.5 py-1.5 rounded-xl bg-amber-500 text-slate-950 hover:bg-amber-400 font-bold text-xs shadow-md transition-all active:scale-95 cursor-pointer"
              title="Save only this Resume as PDF"
            >
            ...
            <button
              onClick={handlePrint}
              className="hidden sm:flex items-center gap-1.5 px-3.5 py-1.5 rounded-xl bg-slate-800 text-amber-300 hover:bg-slate-700 font-bold text-xs border border-amber-500/30 shadow-md transition-all active:scale-95 cursor-pointer"
        ...
        <div
          ...
          className="resume-printable-content p-6 sm:p-8 md:p-10 overflow-y-auto space-y-8 custom-scrollbar bg-[#090d18]"
        >
          ...
          <div className="border-b border-slate-800 pb-6">
            ...
            <div className="flex flex-wrap items-center gap-x-4 gap-y-2 text-xs sm:text-sm text-slate-300">
              <span className="flex items-center gap-1 text-amber-400 font-medium">
                <MapPin className="w-3.5 h-3.5 text-amber-400" /> Jabalpur, Madhya Pradesh, India
              </span>
              ...
              <a href={personal.socials.leetcode} target="_blank" rel="noreferrer" className="flex items-center gap-1 text-amber-400 hover:underline">
                <svg className="w-3.5 h-3.5 fill-current text-amber-400" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
          ...
          <div className="space-y-2">
            <h2 className="text-sm font-extrabold uppercase tracking-wider text-amber-400 flex items-center gap-2 border-b border-slate-800/80 pb-1">
              <Sparkles className="w-4 h-4 text-amber-400" /> Professional Summary
            </h2>
          ...
          <div className="space-y-3">
            <h2 className="text-sm font-extrabold uppercase tracking-wider text-amber-400 flex items-center gap-2 border-b border-slate-800/80 pb-1">
              <Code className="w-4 h-4 text-amber-400" /> Technical Skills
            </h2>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-xs sm:text-sm">
              <div className="resume-card-print p-3.5 rounded-xl bg-slate-900/70 border border-slate-800">
          ...
          <div className="space-y-4">
            <h2 className="text-sm font-extrabold uppercase tracking-wider text-amber-400 flex items-center gap-2 border-b border-slate-800/80 pb-1">
              <Award className="w-4 h-4 text-amber-400" /> Featured Projects
            </h2>

            {/* Project 1 */}
            <div className="resume-card-print p-4 sm:p-5 rounded-2xl bg-slate-900/70 border border-slate-800 space-y-2">
              <div className="flex flex-wrap items-center justify-between gap-1">
                <h3 className="font-bold text-base text-white">
                  Global-Syndicate-Taskforce — Multi-Agent AML Simulator
                </h3>
                <span className="resume-badge-print text-xs font-semibold text-amber-400">April 2026</span>
              </div>
            ...
            <div className="resume-card-print p-4 sm:p-5 rounded-2xl bg-slate-900/70 border border-slate-800 space-y-2">
              <div className="flex flex-wrap items-center justify-between gap-1">
                ...
                <span className="resume-badge-print text-xs font-semibold text-amber-400">December 2025</span>
              </div>
              <div className="text-xs font-medium text-slate-400">
            ...
            <div className="resume-card-print p-4 sm:p-5 rounded-2xl bg-slate-900/70 border border-slate-800 space-y-2">
              <div className="flex flex-wrap items-center justify-between gap-1">
                ...
                <span className="resume-badge-print text-xs font-semibold text-amber-400">September 2025</span>
              </div>
              <div className="text-xs font-medium text-slate-400">
          ...
          <div className="space-y-4">
            <h2 className="text-sm font-extrabold uppercase tracking-wider text-amber-400 flex items-center gap-2 border-b border-slate-800/80 pb-1">
              <Briefcase className="w-4 h-4 text-amber-400" /> Professional Experience
            </h2>

            {/* Exp 1 */}
            <div className="resume-card-print p-4 rounded-2xl bg-slate-900/70 border border-slate-800 space-y-2">
              <div className="flex flex-wrap items-center justify-between gap-1">
                <h3 className="font-bold text-sm sm:text-base text-white">
                  BRBRAITT (Telecom Sector Skill Council) — Trainee, Telecom Analysis
                </h3>
                <span className="resume-badge-print text-xs font-semibold text-amber-400">December 2025 | Jabalpur, MP</span>
              </div>
              <ul className="list-disc list-inside space-y-1 text-xs sm:text-sm text-slate-300 leading-relaxed pl-1">
            ...
            <div className="resume-card-print p-4 rounded-2xl bg-slate-900/70 border border-slate-800 space-y-2">
              <div className="flex flex-wrap items-center justify-between gap-1">
                ...
                <span className="resume-badge-print text-xs font-semibold text-amber-400">Jan 2025 – Feb 2025 | Remote</span>
              </div>
              <ul className="list-disc list-inside space-y-1 text-xs sm:text-sm text-slate-300 leading-relaxed pl-1">
            ...
            <div className="resume-card-print p-4 rounded-2xl bg-slate-900/70 border border-slate-800 space-y-2">
              <div className="flex flex-wrap items-center justify-between gap-1">
                ...
                <span className="resume-badge-print text-xs font-semibold text-amber-400">August 2024 | Jabalpur, India</span>
              </div>
              <ul className="list-disc list-inside space-y-1 text-xs sm:text-sm text-slate-300 leading-relaxed pl-1">
          ...
          <div className="space-y-3">
            ...
            <div className="resume-card-print p-4 rounded-2xl bg-slate-900/70 border border-slate-800 flex flex-wrap items-center justify-between gap-2">
              <div>
                <h3 className="font-bold text-base text-white">
              ...
              <span className="resume-badge-print px-3 py-1 rounded-full text-xs font-bold bg-amber-500/20 text-amber-300 border border-amber-500/40">
                2023 – 2027
              </span>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="resume-card-print p-4 rounded-2xl bg-slate-900/70 border border-slate-800 space-y-2">
              <h3 className="font-bold text-xs uppercase tracking-wider text-amber-400 flex items-center gap-1.5">
                <Award className="w-4 h-4 text-amber-400" /> Certifications & Achievements
              </h3>
            ...
            <div className="resume-card-print p-4 rounded-2xl bg-slate-900/70 border border-slate-800 space-y-2">
              <h3 className="font-bold text-xs uppercase tracking-wider text-amber-400 flex items-center gap-1.5">
                <Globe className="w-4 h-4 text-amber-400" /> Additional Information
              </h3>
              <ul className="space-y-1.5 text-xs text-slate-300">
        ...
        <div className="resume-modal-footer no-print flex items-center justify-between px-6 py-4 bg-slate-900/90 border-t border-slate-800 shrink-0">
          ...
          <div className="flex items-center gap-3">
            <button
              onClick={handlePrint}
              className="flex items-center gap-1.5 px-4 py-2 rounded-xl bg-amber-500 text-slate-950 font-bold text-xs hover:bg-amber-400 transition-all shadow-lg cursor-pointer"
              title="Save this resume as PDF"
            >
              <Download className="w-3.5 h-3.5" />
              <span>Download PDF</span>
            </button>
            <button
              onClick={handlePrint}
              className="hidden sm:flex items-center gap-1.5 px-4 py-2 rounded-xl bg-slate-800 text-amber-400 font-bold text-xs hover:bg-slate-700 transition-all shadow-lg border border-amber-500/30 cursor-pointer"
              title="Print resume"
            >
              <Printer className="w-3.5 h-3.5" />
              <span>Print</span>
